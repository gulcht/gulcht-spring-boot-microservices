package com.gulcht.microservices.notification.service;
...
public class NotificationService {
    ...
    public void listen(OrderPlacedEvent orderPlacedEvent){
        log.info("Get Message from kafka topic: order-placed: {}", orderPlacedEvent);

        // send email to customer
        MimeMessagePreparator mimeMessagePreparator = MimeMessagePreparator -> {
            MimeMessageHelper mimeMessageHelper = new MimeMessageHelper(MimeMessagePreparator);
